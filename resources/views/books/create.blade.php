                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('books.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="border rounded w-full py-2 px-3" value="{{ old('title') }}" required>
                            @error('title') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">Penerbit</label>
                            <input type="text" name="publisher" class="border rounded w-full py-2 px-3" value="{{ old('publisher') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="dimension" class="border rounded w-full py-2 px-3" value="{{ old('dimension') }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="stock" class="border rounded w-full py-2 px-3" value="{{ old('stock') }}" min="0" required>

                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('members.update', $member->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="member_no" class="border rounded w-full py-2 px-3" value="{{ old('member_no', $member->member_no) }}" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="date_of_birth" class="border rounded w-full py-2 px-3" value="{{ old('date_of_birth', $member->date_of_birth) }}" required>
